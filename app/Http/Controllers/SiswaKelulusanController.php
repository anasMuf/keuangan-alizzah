...
class SiswaKelulusanController extends Controller
{
    public function index() {
        ...
        $resultTahunAjaranDisabled = [];
        foreach (TahunAjaran::whereNotIn('id',[$data['tahunAjaranTujuan']])->get()->toArray() as $item) {
            $resultTahunAjaranDisabled[] = $item['id'];
        }
        $data['tahunAjaranDisabled'] = $resultTahunAjaranDisabled;

        return view('pages.siswa_kelulusan.index',$data);
    }

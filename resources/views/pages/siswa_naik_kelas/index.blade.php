...
@section('subtitle', 'Siswa Naik Kelas')
@section('content_header_title', 'Home')
@section('content_header_subtitle', 'Siswa Naik Kelas')
...
<x-adminlte-card title="Form Siswa Naik Kelas">
...
@push('js')
    ...
    <script>
        $('#formData').submit(function (e) {
            ...
            $.post("{{ route('siswa_naik_kelas.store') }}", data)
            .done(function (response) {
                if(response.success){
                    ...
                    setTimeout(() => {
                        location.href = "{{ route('siswa_naik_kelas.main') }}"
                    }, timer);
                }else{

...
@section('subtitle', 'Siswa Pindah Kelas')
@section('content_header_title', 'Home')
@section('content_header_subtitle', 'Siswa Pindah Kelas')
...
<x-adminlte-card title="Form Siswa Pindah Kelas">
...
@push('js')
    ...
    <script>
        $('#formData').submit(function (e) {
            ...
            $.post("{{ route('siswa_pindah_kelas.store') }}", data)
            .done(function (response) {
                if(response.success){
                    ...
                    setTimeout(() => {
                        location.href = "{{ route('siswa_pindah_kelas.main') }}"
                    }, timer);
                }else{
